...
// Components
import { QRCode, CopyToClipboard, OrderStatusTag, PartyParrotLoader } from '..';
  ...
  return (
    <Row gutter={[0, 24]}>
      {payinAddress ? (
        <Col span={24}>
          ...
          >
            ...
            <Col xs={12} sm={24} md={24} lg={24}>
              ...
              {isPayinAddressCopied ? <Text style={{ color: '#1890FF' }}>[Copied!]</Text> : null}
              <br />
              <CopyToClipboard
                text={payinAddress}
                onCopy={() => {
        ...
        <Col span={24}>
          <PartyParrotLoader size="50px">
            <Text style={{ fontSize: '0.825rem' }}>Loading...</Text>
          </PartyParrotLoader>
        </Col>
      )}
    </Row>
